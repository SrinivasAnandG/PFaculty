 ...
 */
public class NotifyBoth  extends Fragment{
    Spinner year,branch;
    EditText msg;
    Button send;
    @Nullable
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.notify_both,container,false);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!branch1.equals("Branch")&&!year1.equals("Batch"))
                {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(map!=null)
                                {
                                    for(Map.Entry m:map.entrySet()){
                                        ...
                                        if((email.substring(0,2)).equals(year1)&&(email.substring(6,8)).equals(branch2))
                                        {
                                            //Toast.makeText(getContext(),email.substring(0,2)+" "+email.substring(6,8),Toast.LENGTH_SHORT).show();
